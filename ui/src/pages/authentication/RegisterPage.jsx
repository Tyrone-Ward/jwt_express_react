      ...
      >
        <div class='max-w-xl lg:max-w-3xl'>
          <div class='relative -mt-16 block lg:hidden'>
            <a
              class='inline-flex size-16 items-center justify-center rounded-full  text-blue-600 sm:size-20'
              href='/'
            >
              <span class='sr-only'>Home</span>
              <svg
          ...
          <form onSubmit={handleSubmit} class='mt-8 grid grid-cols-6 gap-6' method='POST'>
